...
সি ল্যাঙ্গুয়েজে যখন দুটি ভিন্ন টাইপের ডাটা (যেমন একটি int এবং একটি float) কোনো গাণিতিক কাজ করে, 
তখন কম্পিউটার ছোট টাইপটিকে স্বয়ংক্রিয়ভাবে বড় টাইপে রূপান্তর করে নেয়। মেমোরি এবং প্রিসিশনের দিক থেকে float যেহেতু int এর চেয়ে বড়, তাই রেজাল্ট সবসময় float আসবে।
int / float করলে:

যখন একটি পূর্ণসংখ্যাকে (int) একটি দশমিক সংখ্যা (float) দিয়ে ভাগ করা হয়, তখন রেজাল্ট একটি দশমিক সংখ্যা বা float হবে।
int a = 5;
float b = 2.0;
float result = a / b; // ৫ কে ২.০ দিয়ে ভাগ

কম্পিউটার যখন দেখল একপাশে int আর অন্যপাশে float, সে তখন নিজের মনে মনে int কেও float বানিয়ে নিল। অর্থাৎ হিসাবটা হলো: 5.0 / 2.0 = 2.5।
    
অপারেশন                             উদাহরণ              রেজাল্টটাইপ                     আউটপুট
int / int                             5 / 2                2                              int
int / float                           5 / 2.0              float                          2.5
float / int                           5.0 / 2              float                          2.5
