...
প্রোগ্রামিংয়ে যখন দশমিকের ঘর নির্দিষ্ট করে দাও, তখন কম্পিউটার সবসময় তার পরের ঘরটি (Next Digit) চেক করে।

তোমার সংখ্যা: 123.12342 6 789

এখানে ৫ম ঘর হলো: 2

এবং ৬ষ্ঠ ঘর (যেটি বাদ পড়বে) হলো: 6

নিয়মটি হলো: যদি বাদ পড়া প্রথম ঘরটি ৫ বা তার বেশি হয়, তবে আগের ঘরের সাথে ১ যোগ হবে। যেহেতু এখানে ৬ষ্ঠ ঘরটি 6, যা ৫-এর চেয়ে বড়, তাই এটি ৫ম ঘরের 2-এর সাথে ১ যোগ করে সেটিকে 3 বানিয়ে দিয়েছে।

৩. যদি ৬ না হয়ে ৪ হতো?
যদি তোমার কোডটি এমন হতো: float a = 123.123424...
